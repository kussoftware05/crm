...
/**
 * This is the model class for table "shipping_master".
 *
 * @property int $id
 ...
 * @property User $user
 */
class ShippingMaster extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(OrderMaster::className(), ['shipping_id' => 'id']);
    }
